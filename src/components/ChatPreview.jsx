...
export default function ChatPreview() {
  return (
    <section id="chat-preview" className="py-8 md:py-16 px-4 md:px-8">
      <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-[48px] font-bold text-center text-cyan-200 mb-8 md:mb-20 mt-8 md:mt-20 font-cyberpunk drop-shadow-[0_0_8px_#0ff]" style={{textShadow:'0 0 12px #0ff, 0 0 32px #a0f, 0 0 2px #fff'}}>실시간 대화 인터페이스를 직접 확인해보세요</h2>
